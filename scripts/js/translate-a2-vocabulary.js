...
// Configuration
const INPUT_FILE = 'a2-vocabulary-clean.json';
const OUTPUT_FILE = 'a2-vocabulary-complete.json';
const PROGRESS_FILE = 'a2-translation-progress.json';
...
async function main() {
  ...
  console.log('🚀 A2 Vocabulary Translation Script\n');
