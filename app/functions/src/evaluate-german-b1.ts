...
// IMPORTANT: Use Firebase Functions environment variables to store the API key
// Set it using: firebase functions:config:set openai.key="your-api-key"
// Then access it using: functions.config().openai.key
const OPENAI_API_KEY = process.env.OPENAI_API_KEY || ''; // Load from environment variable
