...
const ListeningPart4Screen: React.FC = () => {
  ...
  const { isCompleted, toggleCompletion } = useExamCompletion('listening-part4', examId);
  ...
  const loadData = async () => {
    try {
      ...
      setListeningData(data);
        ...
        const progress = getExamProgress('listening-part4', String(examId));
  ...
  const handleComplete = (score: number, answers: UserAnswer[]) => {
    ...
    updateExamProgress('listening-part4', examId, answers, score, totalQuestions);
  };
