...
import { ReadingPart3A1Exam, UserAnswer, ExamResult , ExamProgress } from '../../types/exam.types';
...
const ReadingPart3A1Screen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <ReadingPart3A1UI key={uiKey} exam={currentExam} onComplete={handleComplete} initialAnswers={resumedAnswers} />
