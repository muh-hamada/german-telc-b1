...
export const germanB1Config: ExamConfig = {
  ...
  ads: {
    ...
    appOpen: {
      android: 'ca-app-pub-5101905792101482/2325056568',
      ios: 'ca-app-pub-5101905792101482/5623520781',
    },
  },
    ...
    },
    {
      ...
      parts: [
        ...
        },
        {
          ...
          wrapperKey: 'SpeakingPart2Wrapper',
          ...
          dataLoader: { listMethod: 'getSpeakingPart2Content', fetchMethod: 'getSpeakingPart2Content', listResponseKey: 'topics' },
        ...
        },
        {
          ...
          wrapperKey: 'SpeakingPart3Wrapper',
          ...
          dataLoader: { listMethod: 'getSpeakingPart3Content', fetchMethod: 'getSpeakingPart3Content', listResponseKey: 'scenarios' },
          navigationParamKey: 'scenarioId',
          modalItemType: 'exam.scenario',
          maxPoints: 30,
          timeMinutes: 6,
          scoringGroup: 'oral',
          mockExamSectionName: 'Mündlicher Ausdruck',
        ...
        },
        {
          ...
          dataLoader: { listMethod: 'getSpeakingImportantPhrases', fetchMethod: 'getSpeakingImportantPhrases', listResponseKey: 'groups' },
          navigationParamKey: 'groupIndex',
          modalItemType: 'exam.part',
          separatorBeforeKey: 'practice.speaking.separator',
          maxPoints: 0,
          timeMinutes: 0,
          scoringGroup: 'oral',
          hasExamSelection: true,
