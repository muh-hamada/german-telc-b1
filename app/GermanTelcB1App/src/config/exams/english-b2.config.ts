      ...
      parts: [
        {
          ...
          dataLoader: { listMethod: 'getSpeakingB2Part1Content', fetchMethod: 'getSpeakingB2Part1Content' },
          maxPoints: 15,
          timeMinutes: 3,
          scoringGroup: 'oral',
        ...
        },
        {
          ...
          dataLoader: { listMethod: 'getSpeakingB2Part2Content', fetchMethod: 'getSpeakingB2Part2Content' },
          maxPoints: 30,
          timeMinutes: 6,
          scoringGroup: 'oral',
          mockExamSectionName: 'Mündlicher Ausdruck',
        ...
        },
        {
          ...
          dataLoader: { listMethod: 'getSpeakingB2Part3Content', fetchMethod: 'getSpeakingB2Part3Content' },
          maxPoints: 30,
          timeMinutes: 6,
          scoringGroup: 'oral',
          mockExamSectionName: 'Mündlicher Ausdruck',
