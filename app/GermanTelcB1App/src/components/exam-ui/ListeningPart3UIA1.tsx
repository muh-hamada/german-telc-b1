...
interface ListeningPart3UIA1Props {
  exam: Exam;
  sectionDetails: any;
...
const ListeningPart3UIA1: React.FC<ListeningPart3UIA1Props> = ({ exam, sectionDetails, onComplete, initialAnswers }) => {
  ...
  const handleSubmit = () => {
    ...
    if (unansweredQuestions.length > 0) {
      Alert.alert(
        ...
        t('listening.part3.incompleteMessage', { count: unansweredQuestions.length }),
        [{ text: 'OK' }]
      );
      return;
    }
...
export default ListeningPart3UIA1;
