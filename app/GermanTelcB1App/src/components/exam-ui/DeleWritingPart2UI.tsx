...
interface DeleWritingPart2UIProps {
  exam: DeleWritingExam;
  onComplete: (score: number, answers: UserAnswer[]) => void;
  isMockExam?: boolean;
}

const DeleWritingPart2UI: React.FC<DeleWritingPart2UIProps> = ({ exam, onComplete, isMockExam = false }) => {
...
export default DeleWritingPart2UI;
