...
import { ReadingPart3A1Exam, UserAnswer } from '../../types/exam.types';
  ...
  const handleSubmit = () => {
    if (Object.keys(userAnswers).length < exam.questions.length) {
      Alert.alert(
        ...
        t('reading.part3.incompleteMessage'),
        [{ text: 'OK' }]
      );
      return;
    }
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      ...
      <View style={styles.instructionsCard}>
        ...
        <Text style={styles.instructionsText}>
          {t('reading.part3.a1TaskDescription')}
        </Text>
      </View>
...
export default ReadingPart3A1UI;
