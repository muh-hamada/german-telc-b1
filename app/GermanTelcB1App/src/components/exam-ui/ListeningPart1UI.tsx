...
const ListeningPart1UI: React.FC<ListeningPart1UIProps> = ({ exam, sectionDetails, onComplete, initialAnswers }) => {
  ...
  const handlePlayAudio = async () => {
    ...
    try {
      ...
      console.log('[ListeningPart1] Playing audio from:', audioPath);
