...
const ListeningPart2UI: React.FC<ListeningPart2UIProps> = ({ exam, sectionDetails, onComplete, initialAnswers }) => {
  ...
  const handlePlayAudio = async () => {
    ...
    try {
      ...
      console.log('[ListeningPart2] Playing audio from:', audioPath);
