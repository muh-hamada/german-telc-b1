...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  playButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.audioControl.background, padding: 12, borderRadius: 8, marginTop: 12 },
  playButtonDisabled: { opacity: 0.6 },
  playButtonText: { color: colors.audioControl.text, fontSize: 14, fontWeight: '600', marginLeft: 8 },
